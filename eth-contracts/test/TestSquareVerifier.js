...
contract('Verifier', accounts => {
    ...
    it('Proof of Work',async () => {
        ...
        let output = await self.contract.verifyTx.call(proof.a,proof.b,proof.c,proof.inputs);
        assert.equal(output,true,"Proof of Work Failed!.");
    })

    // Test verification with incorrect proof
    it('Testing with Incorrect Proof', async () => {
        let self = this;
        let proof = {
            "a": [
            "0x1ba0df5159c4c75da8a30d34e28b0a2242b9634aed77c9b41b979e6081ed5033",
        ...
        let output = await self.contract.verifyTx.call(proof.a,proof.b,proof.c,proof.inputs);
        assert.equal(output,false,"Working with Incorrect Proof!");
        })
    })
})