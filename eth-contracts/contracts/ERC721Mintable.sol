...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0),"You already owned the Ownership!");
        _owner = newOwner;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Already Owned the Token!.");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == owner || isApprovedForAll(owner,msg.sender),"Only Approved to the Operator and the Token Owner!");        
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0),"'to' Invalid Address");
        // TODO: clear approval
...
contract ERC721Mint is ERC721Metadata("Sreesankars RealEstate Solutions","SRS","https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
    
    function mint(address to, uint tokenId, string memory tokenURI) public onlyOwner returns(uint256){
        super._mint(to,tokenId);
